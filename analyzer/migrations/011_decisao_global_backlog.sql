-- Backlog da 010 com folga: a tela da fila pode estar aberta há alguns minutos, então
-- empresas que surgiram até 10 min antes da decisão em lote não estavam nela
-- (ex.: googlevideo.com — 2D Tecnologia apareceu 30 s antes da decisão).
